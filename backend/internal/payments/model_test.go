...
func TestPaymentStateTransitions(t *testing.T) {
	tests := []struct {
		...
		{StateProcessing, StateBankSettledCentralPending, true},
		{StateBankSettledCentralPending, StateCommitted, true},
		{StateBankSettledCentralPending, StatePendingReconciliation, true},
